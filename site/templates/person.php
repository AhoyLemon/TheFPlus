      ...
      <ul class="personal-links">
        ...
        <?php if ($page->twitter() != ""): ?>
          <li>
            ...
            <a href="https://twitter.com/<?php echo $page->twitter() ?>" target="_blank">
        ...
        <?php if ($page->email() != ""): ?>
          <li>
            ...
            <a itemprop="email" content="<?php echo $page->email() ?>" href="mailto:<?php echo $page->email() ?>" target="_blank"><?php echo $page->email() ?></a>
          </li>
        <?php endif ?>
        ...
        <?php if ($page->ballpit_account() != ""): ?>
          <li>
            ...
            <a href="<?php echo $page->ballpit_account() ?>">ballp.it profile</a>
          </li>
        <?php endif ?>
      </ul>
    </header>
