...
<main class="main page" role="main">
  ...
  <article class="episode full" itemscope itemtype="http://schema.org/Episode">
    ...
    <!-- RSS LINK -->
    <div class="subscribe-episode">
      <a class="button icon-link-button subscribe-via-rss" id="SubscribeOnEpisdeButton" href="<?= $site->url(); ?>/episode/feed" title="RSS Feed" onclick="trackEvent('sidebar link', 'RSS Feed', '<?= $site->url(); ?>/episode/feed');">
    ...
    <div class="document-link-holder">
      <?php if ($page->document_link()->isNotEmpty()) { ?>
        <a itemprop="citation" class="icon-link-button action read" href="<?php echo $page->document_link() ?>" title="Read <?php echo $page->provider() ?>'s document"  target="_blank">
