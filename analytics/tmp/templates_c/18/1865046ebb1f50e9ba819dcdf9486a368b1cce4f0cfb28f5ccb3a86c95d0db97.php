...
class __TwigTemplate_0446281f5e91992abbaab9661cf5fa613a50eddb5aa36c3471b817347c9991a0 extends Twig_Template
{
    ...
    protected function doDisplay(array $context, array $blocks = array())
    {
        ...
        if ($this->getAttribute((isset($context["properties"]) ? $context["properties"] : $this->getContext($context, "properties")), "show_visualization_only", array())) {
            ...
            echo \Piwik\piwik_escape_filter($this->env, (isset($context["visualizationCssClass"]) ? $context["visualizationCssClass"] : $this->getContext($context, "visualizationCssClass")), "html", null, true);
            echo " ";
            echo \Piwik\piwik_escape_filter($this->env, (($this->getAttribute((isset($context["properties"]) ? $context["properties"] : null), "datatable_css_class", array(), "any", true, true)) ? (_twig_default_filter($this->getAttribute((isset($context["properties"]) ? $context["properties"] : null), "datatable_css_class", array()), "")) : ("")), "html", null, true);
            echo " ";
     ...
     data-table-type=\"";
            // line 8
            echo \Piwik\piwik_escape_filter($this->env, $this->getAttribute((isset($context["properties"]) ? $context["properties"] : $this->getContext($context, "properties")), "datatable_js_type", array()), "html", null, true);
            echo "\"
     data-report=\"";
            // line 9
     ...
     data-report-metadata=\"";
            // line 10
            echo \Piwik\piwik_escape_filter($this->env, twig_jsonencode_filter((isset($context["reportMetdadata"]) ? $context["reportMetdadata"] : $this->getContext($context, "reportMetdadata"))), "html_attr");
            echo "\"
     data-props=\"";
            // line 11
        ...
        ";
                ...
                ";
                    ...
                    if ((array_key_exists("showReportDataWasPurgedMessage", $context) && (isset($context["showReportDataWasPurgedMessage"]) ? $context["showReportDataWasPurgedMessage"] : $this->getContext($context, "showReportDataWasPurgedMessage")))) {
                        // line 24
                        echo "                    ";
                        echo \Piwik\piwik_escape_filter($this->env, call_user_func_array($this->env->getFilter('translate')->getCallable(), array("CoreHome_DataForThisReportHasBeenPurged", (isset($context["deleteReportsOlderThan"]) ? $context["deleteReportsOlderThan"] : $this->getContext($context, "deleteReportsOlderThan")))), "html", null, true);
                        echo "
                ";
                    } else {
                        // line 26
    ...
    {
        return "{% if properties.show_visualization_only %}
