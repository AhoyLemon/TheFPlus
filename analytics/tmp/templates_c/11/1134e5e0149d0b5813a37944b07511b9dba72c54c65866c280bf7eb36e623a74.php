...
class __TwigTemplate_52075a8764edab00eb0de5c425f92070a614aef3f749c439447c4307786c72f1 extends Twig_Template
{
    ...
    ";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["dateCountPair"]) {
            ...
            // line 5
            echo "        <span data-date=\"";
            echo \Piwik\piwik_escape_filter($this->env, (isset($context["date"]) ? $context["date"] : $this->getContext($context, "date")), "html", null, true);
            echo "\" data-count=\"";
            echo \Piwik\piwik_escape_filter($this->env, $this->getAttribute((isset($context["counts"]) ? $context["counts"] : $this->getContext($context, "counts")), "count", array()), "html", null, true);
            echo "\" data-starred=\"";
            echo \Piwik\piwik_escape_filter($this->env, $this->getAttribute((isset($context["counts"]) ? $context["counts"] : $this->getContext($context, "counts")), "starred", array()), "html", null, true);
            echo "\"
              ";
            // line 6
            if (($this->getAttribute((isset($context["counts"]) ? $context["counts"] : $this->getContext($context, "counts")), "count", array()) == 0)) {
                echo "title=\"";
                echo \Piwik\piwik_escape_filter($this->env, call_user_func_array($this->env->getFilter('translate')->getCallable(), array("Annotations_AddAnnotationsFor", (isset($context["date"]) ? $context["date"] : $this->getContext($context, "date")))), "html", null, true);
                echo "\"
              ";
...
";
              ...
              ";
                ...
                // line 10
                echo "}title=\"";
                echo \Piwik\piwik_escape_filter($this->env, call_user_func_array($this->env->getFilter('translate')->getCallable(), array("Annotations_ViewAndAddAnnotations", (isset($context["date"]) ? $context["date"] : $this->getContext($context, "date")))), "html", null, true);
                echo "\"";
            }
            echo ">
...
";
    ...
    {
        return "<div class=\"evolution-annotations\">
