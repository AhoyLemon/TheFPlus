...
class __TwigTemplate_71837413c43d0a61e44df078b0148cd644f5201ad74fe9a6dd97deab6a3a0491 extends Twig_Template
{
    ...
    <div class=\"segmentationContainer listHtml\" title=\"";
        ...
        echo ". ";
        echo \Piwik\piwik_escape_filter($this->env, call_user_func_array($this->env->getFilter('translate')->getCallable(), array("SegmentEditor_CurrentlySelectedSegment", (isset($context["segmentDescription"]) ? $context["segmentDescription"] : $this->getContext($context, "segmentDescription")))), "html_attr");
        echo "\">
...
<div class=\"ui-confirm segment-definition-change-confirm\" data-segment-processed-on-request=\"";
        // line 170
        echo \Piwik\piwik_escape_filter($this->env, twig_number_format_filter($this->env, (isset($context["segmentProcessedOnRequest"]) ? $context["segmentProcessedOnRequest"] : $this->getContext($context, "segmentProcessedOnRequest"))), "html", null, true);
        echo "\" data-hide-message=\"";
        echo \Piwik\piwik_escape_filter($this->env, (isset($context["hideSegmentDefinitionChangeMessage"]) ? $context["hideSegmentDefinitionChangeMessage"] : $this->getContext($context, "hideSegmentDefinitionChangeMessage")), "html", null, true);
        echo "\">
    <h2>
...
<div class=\"ui-confirm pleaseChangeBrowserAchivingDisabledSetting\">
    ...
    <p class=\"description\">
        ...
        if ((isset($context["isSuperUser"]) ? $context["isSuperUser"] : $this->getContext($context, "isSuperUser"))) {
            // line 197
            echo "            <br/> <br/> ";
            echo \Piwik\piwik_escape_filter($this->env, call_user_func_array($this->env->getFilter('translate')->getCallable(), array("SegmentEditor_YouMayChangeSetting", "browser_archiving_disabled_enforce", (isset($context["segmentSetting"]) ? $context["segmentSetting"] : $this->getContext($context, "segmentSetting")))), "html", null, true);
            echo "
        ";
        }
        // line 199
