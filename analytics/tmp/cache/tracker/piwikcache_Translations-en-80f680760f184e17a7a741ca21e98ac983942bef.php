...
Piwik will let you track visitors to your website for free. You should definitely check it out!',
    ...
    array (
      ...
      'IncompatbilePluginsWillBeDisabledInfo' => 'Note: some plugins are not compatible with Piwik %s. We will update them if there is an update on the Marketplace, otherwise we will disable them when you upgrade:',
...
And thank you for using Piwik!',
    ...
    array (
      ...
      'PluginLicenseMissingDescription' => 'You are not allowed to download this plugin because there is no license for this plugin. To resolve this issue either update your license key, get a subscription or deactivate the plugin.',
